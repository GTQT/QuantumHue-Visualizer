...
public class EBFPage extends MultiblockBase {
    ...
    public String getMarkdownContent() {
        return "# " + getPageTitle()
                ...
                + "\n\n" + "## 进阶自动化教程"
                + "\n\n" + "工业高炉和其他各种GT大机器一样，允许多个工业高炉共用以节省材料。功能性仓室都可以共用。需要注意能源仓共用的时候是同时给两边各提供1A电流，所以高炉如果需要升压的话，请不要共用能源仓。"
                + "\n\n" + "本项目内置了一套SatisMC格式的蓝图，位于quantumhue:wiki/bp_4x_ebf.json，可直接导入蓝图库放置"
                + "\n\n![blueprint:quantumhue:wiki/bp_4x_ebf]"
                ;
    }
}

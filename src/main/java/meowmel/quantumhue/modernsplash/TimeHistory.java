...
public class TimeHistory {
    private static final org.apache.logging.log4j.Logger LOGGER = org.apache.logging.log4j.LogManager.getLogger("TimeHistory");
    ...
    public static long getEstimateTime() {
        ...
        {
            LOGGER.debug("Could not load time.history, will create a default one");
        }
    ...
    public static void saveHistory(long time) {
        ...
        {
            LOGGER.debug("Could not save the time.history file", e);
        }

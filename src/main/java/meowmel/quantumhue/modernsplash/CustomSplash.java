/*
 * The "MOJANG STUDIO" image is property of Mojang Synergies AB
 * This file (CustomSplash.java) is licensed under LGPL 2.1
 * Other code is licensed under MIT
 */
...
public class CustomSplash
{
    ...
    public static final org.apache.logging.log4j.Logger LOGGER = org.apache.logging.log4j.LogManager.getLogger("ModernSplash");
    ...
    public static void start()
    {
        ...
        final ResourceLocation logoLoc = new ResourceLocation(config.getString("logoTexture", categoryGeneral, "quantumhue:textures/gui/title/mojang.png", "Resource location of main logo"));
        ...
        thread = new Thread(new Runnable()
        {
            ...
            private String getString(){
                ...
                if(ModernSplashEvents.doneTime > 0) startupTime = ModernSplashEvents.doneTime;
    ...
    private static InputStream open(ResourceLocation loc, @Nullable ResourceLocation fallback, boolean allowResourcePack) throws IOException
    {
        ...
        if (fmlPack == null) {
            fmlPack = createResourcePack(net.minecraftforge.fml.common.asm.FMLSanityChecker.fmlLocation);
        }
